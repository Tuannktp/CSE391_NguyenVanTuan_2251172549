...
function cheapestByCategory(products) {
    return products.reduce((acc, curr) => {
        // Nếu danh mục này chưa có trong acc hoặc tìm thấy sản phẩm có giá rẻ hơn sản phẩm hiện tại trong acc
...
function averageRating(products) {
    ...
    return Math.round((totalRating / products.length) * 100) / 100; // Làm tròn 2 chữ số thập phân
}
...
// Khuyến khích kiểm tra thêm các hàm bổ trợ còn lại
console.log("\n=== RATING TRUNG BÌNH TOÀN KHO ===");
console.log(averageRating(products));

console.log("\n=== DANH SÁCH ĐỊNH DẠNG GIÁ ===");
